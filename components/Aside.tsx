        ...
        <div className="space-y-6">
            ...
            {!hasActiveSubscription && ads.map(ad => (
             ...
             <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
                ...
                <input type="email" placeholder="your.email@example.com" className="mt-3 w-full px-3 py-2 text-sm border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-accent-500 focus:border-accent-500 bg-white dark:bg-gray-700" />
                <button className="mt-2 w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-semibold py-2 px-4 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 text-sm transition-colors">
                    Sign Up
                </button>
            </div>
        </div>
